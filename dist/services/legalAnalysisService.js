export class LegalAnalysisService {
    ...
    async analyzeLegalTrends(legalCases) {
        try {
            ...
            const aiCases = recentCases.filter(c => c.title.toLowerCase().includes('ai') ||
            ...
            const cyberCases = recentCases.filter(c => c.title.toLowerCase().includes('cyber') ||
            ...
            const gdprCases = recentCases.filter(c => c.title.toLowerCase().includes('gdpr') ||
...
//# sourceMappingURL=legalAnalysisService.js.map