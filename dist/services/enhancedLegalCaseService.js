        ...
        const comprehensiveCases = [
            {
                ...
                decisionDate: new Date('2025-09-08'),
...
**Court Motions:**
${comprehensiveCase.litigationTimeline.motions.map(motion => `• ${motion.type} (${motion.date.toLocaleDateString()}): ${motion.outcome.toUpperCase()} - ${motion.details}`).join('\n')}
...
//# sourceMappingURL=enhancedLegalCaseService.js.map