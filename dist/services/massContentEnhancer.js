        ...
        try {
            ...
            for (const update of allUpdates) {
                try {
                    ...
                    const enhancedContent = this.expandContent(update.content || 'Regulatory Update Content', update.deviceType || 'Medical Device', update.therapeuticArea || 'Healthcare', update.jurisdiction || 'Global');
...
//# sourceMappingURL=massContentEnhancer.js.map