...
export class SimpleNewsletterService {
    constructor() {
        this.logger = new Logger('SimpleNewsletterService');
    }
    ...
    async extractNewsletterContent() {
    ...
    generateAuthenticArticles(source) {
...
//# sourceMappingURL=simpleNewsletterService.js.map